...
def collect_expenses():
    ...
    while True:
        expense_type = input("Enter type of expense (rent/power_gas/water_sewer_trash/gas_for_car/car_insurance/car_payment/phone/internet/groceries/household/hygiene/done): ").strip().lower()
